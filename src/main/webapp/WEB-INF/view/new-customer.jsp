          ...
          <div class="container mt-4">
            ...
            <div class="card text-white bg-secondary mb-3" style="max-width: 100%;">
              <div class="card-body">
                ...
                <p class="card-text text-center">Quick example with add customer's content.</p>
              </div>
            </div>
            <h2>Save Customer</h2>
            <form:form method="POST" action="saveCustomer" modelAttribute="newCustomer">
              ...
              <input type="submit" value="Add Customer" class="btn btn-primary btn-block text-center mt-2" />
            </form:form>
          </div>
        </body>
